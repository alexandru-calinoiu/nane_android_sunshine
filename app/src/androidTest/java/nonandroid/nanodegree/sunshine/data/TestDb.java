 ...
 */
package nonandroid.nanodegree.sunshine.data;
...
public class TestDb extends AndroidTestCase {
  ...
  */
  public void testLocationTable() {
    ...
    assertFalse("The insert failed", rowId == -1);

    // Query the database and receive a Cursor back
    Cursor cursor = db.query(WeatherContract.LocationEntry.TABLE_NAME, null, null, null, null, null, null);

    // Move the cursor to a valid database row
    assertTrue("The row was not inserted", cursor.moveToFirst());

    // Validate data in resulting Cursor with the original ContentValues
    // (you can use the validateCurrentRecord function in TestUtilities to validate the
    // query if you like)
    TestUtilities.validateCurrentRecord("The inserted values are not correct.", cursor, TestUtilities.createNorthPoleLocationValues());
  ...
  public void testWeatherTable() {
    ...
    // (you can use the validateCurrentRecord function in TestUtilities to validate the
    // query if you like)
    TestUtilities.validateCurrentRecord("The weather data inserted is not valid", cursor, weatherValues);
  ...
  public long insertLocation(SQLiteDatabase db) {
    return db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, TestUtilities.createNorthPoleLocationValues());
  }
}
